  ...
  <h2>Alta de alumnos</h2>
    <form class="row g-3 needs-validation" novalidate method="get" action="Controller">
        ...
        <div class="col-md-5">
            ...
            <input type="text" class="form-control" id="validationCustom01" value="" name="nombreAlumno" required maxlength="50">
        ...
        <div class="col-md-2">
            ...
            <input type="text" class="form-control" id="validationCustom02" value="" name="cursoAlumno" maxlength="2" required>
            <div class="invalid-feedback">
        ...
        <div class="col-md-2">
            ...
            <div class="input-group has-validation">
                <input type="text" class="form-control" id="validationCustomUsername" name="mediaAlumno"
        ...
        <div class="col-md-3">
            ...
            <input type="date" class="form-control" id="validationCustom03" name="fNaciAlumno" required>
            <div class="invalid-feedback">
